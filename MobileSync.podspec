Pod::Spec.new do |s|
  ...
  s.subspec 'MobileSync' do |mobilesync|
      ...
      mobilesync.source_files = 'libs/MobileSync/MobileSync/Classes/**/*.swift', 'libs/MobileSync/MobileSync/MobileSync.h'
      mobilesync.exclude_files = 'libs/MobileSync/MobileSync/Classes/**/*.m', 'libs/MobileSync/MobileSync/Classes/**/*.h'
